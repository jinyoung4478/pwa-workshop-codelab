...
window.addEventListener('DOMContentLoaded', async () => {
  // Set up the editor
  const { Editor } = await import('https://jinyoung4478.github.io/pwa-workshop-codelab/js/app/editor.js');
  const editor = new Editor(document.body);

  // Set up the menu
  const { Menu } = await import('https://jinyoung4478.github.io/pwa-workshop-codelab/js/app/menu.js');
